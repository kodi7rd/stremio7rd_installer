...
async function defineAddonsJSON(authKey, realDebridApiKey) {
    ...
    async function getMediaFusionEncryptedSecret(realDebridApiKey) {
        const MediaFusionUserSettings = `{"streaming_provider":{"token":"${realDebridApiKey}","service":"realdebrid","enable_watchlist_catalogs":false,"download_via_browser":false,"only_show_cached_streams":true},"selected_catalogs":[],"selected_resolutions":["4k","2160p","1440p","1080p","720p","576p","480p","360p","240p",null],"enable_catalogs":true,"enable_imdb_metadata":false,"max_size":"inf","max_streams_per_resolution":"50","torrent_sorting_priority":["language","cached","resolution","quality","size","seeders","created_at"],"show_full_torrent_name":true,"nudity_filter":["Severe"],"certification_filter":["Adults"],"language_sorting":["English","Tamil","Hindi","Malayalam","Kannada","Telugu","Chinese","Russian","Arabic","Japanese","Korean","Taiwanese","Latino","French","Spanish","Portuguese","Italian","German","Ukrainian","Polish","Czech","Thai","Indonesian","Vietnamese","Dutch","Bengali","Turkish","Greek",null],"quality_filter":["BluRay/UHD","WEB/HD","DVD/TV/SAT","CAM/Screener","Unknown"],"api_password":null,"mediaflow_config":null,"rpdb_config":null,"live_search_streams":false,"contribution_streams":false}`;
